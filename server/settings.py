...
SECRET_KEY = 'django-insecure-om3@!@j+m%z!e3x7e4&x4((x&=cqwqddjhxpm#1#gx891i=l=-'
...
EMAIL_HOST_PASSWORD = 'gljl vkrb tjzj ojix'
...
MIDDLEWARE = [
    ...
    'django.contrib.auth.middleware.AuthenticationMiddleware',  # Removed duplicate
